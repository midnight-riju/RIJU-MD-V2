/**
   * Create By RIJU MD OFFICIAL
   * Contact Me on 919332446037
*/
...
const initializeBot = async () => {
    ...
    console.log(chalk.green('   RIJU MD V.2       '));
    console.log(chalk.yellow('═══════════════════════════════════════════════\n'));
...
function launchBot() {
    console.clear();
    console.log(chalk.green('🚀 RIJU MD V.2 system...\n'));
    ...
    if (fs.existsSync(botPath)) {
        try {
            ...
            require('./bot');
            telegramLoaded = true;
            console.log(chalk.green('✅RIJU MD V.2 bot loaded successfully!'));
        } catch (error) {
    ...
    console.log(chalk.bold.white('RIJU MD V.2BOT INITIALIZATION SUMMARY          '));
    console.log(chalk.cyan('═══════════════════════════════════════════════'));
    console.log(telegramLoaded ? chalk.green('✅RIJU MD V.2 тɛℓɛɢяαм вσт: Active') : chalk.red('❌RIJU MD V.2тɛℓɛɢяαм вσт : Inactive'));
    ...
    if (!telegramLoaded && !whatsappLoaded) {
        ...
        console.log(chalk.green('✅ RIJU MD V.2system is ready and running!\n'));
    }
